...
// if(count($_POST)>0) {
// if(mysqli_query($db,"UPDATE equipments set SLNO='" . $_POST['asl'] . "', DATE_OF_RECEIPT='" . $_POST['ad'] . "',DESCRIPTION='" . $_POST['ades'] . "', NO_ITEMS_RECEIVED='" . $_POST['an'] . "', RATE='" . $_POST['ar'] . "' ,TOTAL_COST='" . $_POST['ac'] . "',TAX_PERCENTAGE='" . $_POST['at'] . "',SUPPLIER_DETAILS='" . $_POST['as'] . "',FUNDING_AGENCY='" . $_POST['af'] . "',STOCK_NO='" . $_POST['asn'] . "',STATE='" . $_POST['astate'] . "',LOCATION='" . $_POST['al'] . "'") > 0)
// {
// echo "string";  
// }
// $message = "Stock Update Successfully";
// }
$result = mysqli_query($db,"SELECT * FROM equipments WHERE SLNO='" . $_GET['SLNO'] . "'");
$row= mysqli_fetch_array($result);

if(isset($_POST['Reject'])) {
mysqli_query($db,"DELETE from equipments  WHERE SLNO='" . $_POST['asl'] . "'");
...
ADD ENTRY</font>
 ...
 <a  href="edit.php"><div  class="active" id="b1">
...
<script src = "https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
 <center>
  <div class="frm" style="">
    <h1>Update Stock</h1>
<form class="form-row" name="addform"  method="post" action="updateprocess.php">
  
<div class="col-md-6">
<input  type="number" name="asl" id="addd" value="<?php echo $row['SLNO']; ?>" readonly>
<label placeholder="Serial Number"></label>
</div>

<div class="col-md-6">
<input  type="date" name="ad" id="addd" value="<?php echo $row['DATE_OF_RECEIPT']; ?>" required>
<label placeholder="Date of Receipt"></label>
</div>

<div class="col-md-6">
<input  type="text" name="ades" id="adddes" value="<?php echo $row['DESCRIPTION']; ?>" required>
<label placeholder="Description of article"></label>
</div>

<div class="col-md-6">
<input required="" name="an" id="addn" onkeypress="myFunction()" value="<?php echo $row['NO_ITEMS_RECEIVED']; ?>" type="number">
<label placeholder="Number of items received"></label>
</div>

<div class="col-md-6">
<input required="" name="ar" id="addr" onkeypress="myFunction()" value="<?php echo $row['RATE']; ?>" type="number">
<label placeholder="Rate"></label>
</div>

<div class="col-md-6">
<input required="" name="ac" id="addc" type="number" value="<?php echo $row['TOTAL_COST']; ?>" readonly>
<label placeholder="Total Cost"></label>
</div>

<div class="col-md-6">
<input required="" name="at" id="addt" type="number" onkeypress="myFunction()" value="<?php echo $row['TAX_PERCENTAGE']; ?>">
<label placeholder="Tax percentage"></label>
</div>


<div class="col-md-6">
<input required="" name="aesr" id="addesr" type="number" value="1" onkeypress="myFunc()">
<label placeholder="ESR Number"></label>
</div>

<div class="col-md-6">
<input required="" name="as" id="adds" type="text" onkeypress="myFunc()" value="<?php echo $row['SUPPLIER_DETAILS']; ?>">
<label placeholder="Supplier details"></label>
</div>

<div class="col-md-6">
<input required="" name="af" id="addf" type="text" onkeypress="myFunc()" value="<?php echo $row['FUNDING_AGENCY']; ?>">
<label placeholder="Funding agency"></label>
</div>

<div class="col-md-6">
<input required="" name="asn" id="addsn" type="text" readonly value="<?php echo $row['STOCK_NO']; ?>">
<label id="addsnp" placeholder="Stock number"></label>
</div>

<div class="col-md-6">
<input required="" name="astate" id="addstate" type="text" value="<?php echo $row['STATE']; ?>">
<label placeholder="State"></label>
</div>

<div class="col-md-6">
<input required="" name="al" id="addl" type="text" value="<?php echo $row['LOCATION']; ?>">
...
<!-- <input type="submit" name="Reject" value="Delete" class="buttom"> -->
<div class="col-md-12">
<button type="submit" name="Reject" class="btn btn-success"><i class="fa fa-trash"></i> Delete</button>
</div>
...
function myfs(){
    toastr["success"]("Stock Updated Successfully!"," Updated");
}
function myff(){
    toastr["error"]("Error in Updating stock!, please try again","Error");
}
function rcheck() {
  if (document.getElementById('addd').value == 0 || document.getElementById('adddes').value == 0 || document.getElementById('addn').value == 0 || document.getElementById('addr').value == 0 || document.getElementById('addc').value == 0 || document.getElementById('addt').value == 0 || document.getElementById('adds').value == 0 || document.getElementById('addf').value == 0 || document.getElementById('addsn').value == 0 || document.getElementById('addstate').value == 0 || document.getElementById('addl').value == 0 ) {
