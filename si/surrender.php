...
<center><h1 style="margin-left:50px;color:white">Stock List</h1></center>
<form  class="example" method="post" id="sf" action="surrender.php" style="margin-left:300px;float:left;margin-top:-50px;max-width:300px;">
...
<a href="surrender.php"><button id="iss" style="margin-left:300px;float:left;" value="Refresh Page">View All</button></a><br><br><br>
</div>
<?php
...
$result = mysqli_query($db,"SELECT * FROM issued WHERE NAME LIKE '".$q."%'   ORDER BY NAME
 ASC ") 
or die("Cannot execute query."); 

//$numrow = mysqli_num_rows($result); 
if ($result->num_rows > 0) {
  echo " <br> <form name='exampl' action='surrenderitem.php' method='post'><div id='tab' style='margin-left:300px;color:white'><table id='t' class='table  table-bordered' style='max-width:50%;'>
    <thead>
      <tr>
        <th>SURRENDER</th>
        <th>SLNO</th>
...
<?php
        ...
        echo "<tr><td><center><input name='id' value = '".$row["ID"]."' type='radio'></center></td><td>" . $row["SLNO"]. " </td><td>" . $row["NAME"]. "</td><td> " . $row["NO_ITEMS_ISSUED"]. "</td><td>" . $row["ISSUED_FROM"]. "</td><td>" .$row["ISSUED_TO"]. "</td><td>" .$row["DATE_OF_ISSUE"]. "</td></tr>" ;
        }
    echo "</tbody></table></div><center><button id='is' type='submit' name='surrender' disabled>SURRENDER</button></form></center><br>";
    ?>
...
if (mysqli_num_rows($result) > 0) {
  echo "  <form name='exampl' action='surrenderitem.php' method='post'> <div id='tab' style='margin-left:300px;color:white'><table id='t' class='table  table-bordered' style='max-width:50%;'>
    <thead>
      <tr>
        <th>SURRENDER</th>
        <th>SLNO</th>
...
<?php
    ...
    echo "</form></tbody></table></div><center><button id='is' type='submit' name='surrender' disabled>SURRENDER</button></form></center><br>";
    ?>
<script type="text/javascript">
  $(function() {
    $('input[type="radio"]').on('click', function() {
    ...
    ?>
    <br><center><div id="nof"><h1 ><font color="white" size="6px;">No stocks are pending</font><br>
...
function myfs(){
    toastr["success"]("Stock returned Successfully!");
}
function myfss(){
    toastr["success"]("Stock returned Successfully!");
}
