...
<form  class="example" method="post" id="sf" action="transfer.php" style="margin-left:300px;float:left;margin-top:-50px;max-width:300px;">
...
<a href="transfer.php"><button id="iss" style="margin-left:300px;float:left;" value="Refresh Page">View All</button></a><br><br><br>
</div>
<?php
...
if ($result->num_rows > 0) {
  echo " <br> <form name='exampl' action='transferitem.php' method='post'><div id='tab' style='margin-left:300px;color:white'><table id='t' class='table  table-bordered' style='max-width:50%;'>
    <thead>
      <tr>
        <th>TRANSFER</th>
        <th>SLNO</th>
...
<?php
    ...
    echo "</tbody></table></div><center><button id='is' type='submit' name='transfer' disabled>TRANSFER</button></form></center><br>";
    ?>
...
if (mysqli_num_rows($result) > 0) {
  echo "  <form name='exampl' action='transferitem.php' method='post'> <div id='tab' style='margin-left:300px;color:white'><table id='t' class='table  table-bordered' style='max-width:50%;'>
    <thead>
      <tr>
        <th>TRANSFER</th>
        <th>SLNO</th>
...
<?php
    ...
    echo "</form></tbody></table></div><center><button id='is' type='submit' name='transfer' disabled>TRANSFER</button></form></center><br>";
    ?>
<script type="text/javascript">
  $(function() {
    $('input[type="radio"]').on('click', function() {
...
function myff(){
    toastr["error"]("Error in transfering stock!, please try again");
}
toastr.options = {
  "closeButton": false,
  "debug": false,
